...
<body class="bg-white">
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2">Nơi sản phẩm Bất động sản xứng tầm giá trị được tìm thấy. Bảo chỉnh chu trong
                        từng chi tiết công việc và đồng hành cùng quý khách để đảm bảo giá trị được bền vững xuyên suốt
                        vòng đời sản phẩm.</p>
                </div>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <div class="d-flex pt-2">
                        <a class="btn btn-outline-light btn-social" href="https://www.tiktok.com/@ngobaorealty"><i
                                class="fa-brands fa-tiktok"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/ngobaoreal"><i
                                class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.instagram.com/ngobaoreal/"><i
    ...
    <div style="position:fixed; top:15%; right:0;" class="toast-container mx-1 my-5 border-0">
        <div id="liveToastBaoGia" class="toast text-bg-success" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <div style="position:fixed; top:15%; right:0;" class="toast-container mx-1 my-5 border-0">
        <div id="liveToastKyGui" class="toast text-bg-success" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex justify-content-between p-3">
                <div class="text-bg-success">
                    Gửi thông tin thành công !
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#liveToastBaoGia').on('shown.bs.toast', function() {
            ...
            $('#liveToastBaoGia').on('hidden.bs.toast', function() {
                // Đóng tab có id= banggia
                $('#banggia').modal('hide');
    ...
    <script>
        $(document).ready(function() {
            // Xử lý khi gửi form thành công và hiện thông báo toasts
            $('#liveToastKyGui').on('shown.bs.toast', function() {
                // Xóa hết value trong input
                $('#kygui input').val('');
            });

            // Xử lý khi đóng toasts
            $('#liveToastKyGui').on('hidden.bs.toast', function() {
                // Xóa hết value trong input
                $('#kygui input').val('');
            });

            // Xử lý khi submit form
            $('#kygui').on('submit', function(e) {
                e.preventDefault();

                $.ajax({
                    type: 'POST',
                    url: '{{ route('kygui.store') }}',
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.success) {
                            var toast = new bootstrap.Toast(document.getElementById(
                            ...
                            // $('#banggia').modal('hide');
                            setTimeout(function() {
                                window.location.href = '/masterise-central-point';
                            }, 1300);
                            toast.show();
                        } else {
                            // Hiển thị toasts lỗi nếu có lỗi
        ...
        $(document).ready(function() {
            ...
            // Xử lý khi submit form
            $('#kyguifooter').on('submit', function(e) {
                e.preventDefault();
